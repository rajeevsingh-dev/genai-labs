"""
Simple AI Foundry Agent Creator
Creates an agent using Azure AI Foundry service
...
project_endpoint = os.environ["AZURE_AI_PROJECT_ENDPOINT"]  # Ensure the PROJECT_ENDPOINT environment variable is set
...
with project_client:
    ...
    agent = project_client.agents.create_agent(
        model=os.environ["AZURE_AI_MODEL_DEPLOYMENT"],  # Model deployment name
